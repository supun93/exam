...
<div class="card-body">
    ...
    <td>
      ...
      <a href="{{route('grades.create')}}/{{$list->grade_group_id}}"><div class="btn btn-xs"><span class="fa fa-edit"></span> Edit</div></a>
...
$(document).ready(function () {
    $(".trashBut").click(function() {
        var row = $(this).closest("tr"),       // Finds the closest row <tr> 
            tds = row.find("td");
            id = tds.find(".id").val();  
            trashFunction("{{route('grades.trash')}}",id,'restore') 
    });    
});
</script>
